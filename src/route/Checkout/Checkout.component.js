...
import './styles.scss'
 ...
 export class Checkout extends PureComponent {
     ...
     renderStepProgresBar() {
       console.log(this.props.shippingMethods[0].available,"ship")
         return(
             <div className="container">
                 <div className={`first-line ${this.props.estimateAddress ? "first-line-active": ""}`}>
...
<div class="step">
       <div className={`bullet ${this.props.estimateAddress ? "bullet-active": ""}`}>1</div>
       <p className="step-text">Shipping</p>
</div>

<div className={`middle-line ${this.props.estimateAddress ? "middle-line-active": ""}`}>
                   
                   </div>
<div class="step">
       <div className={`bullet ${this.props.shippingMethods[0].available? "bullet-shipping": null }`}>2</div>
       <p className="step-text">Review & Paymesnts</p>
</div>
